...
for %%S in (PAN ZOOM_IN PAN_ZOOM) do (
  ...
  REM call :run_tffr VIS_PLOTLY scripts\web\gen_plotly_html_v2.py %%S
  if errorlevel 1 goto fail
  REM call :run_a1 VIS_PLOTLY scripts\web\gen_plotly_html_v2.py %%S
  if errorlevel 1 goto fail
  REM call :run_a2 VIS_PLOTLY scripts\web\gen_plotly_html_v2.py %%S
  if errorlevel 1 goto fail
